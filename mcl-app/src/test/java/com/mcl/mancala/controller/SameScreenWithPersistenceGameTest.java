...
public class SameScreenWithPersistenceGameTest {
    ...
    public void continueGame() throws Exception {
        ...
        GameState resultingGameState = new GameState(3L, resultingMancalaState, gameMechanics.isGameOver(), gameMechanics.whichPlayerWon());

        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = get("/with-persistence/continue?id=-1")
    ...
    public void makeMove() throws Exception {
        ...
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = post("/with-persistence/make-move?id=1" )
                .contentType(MediaType.APPLICATION_JSON)
